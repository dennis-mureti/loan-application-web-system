...
if (mysqli_num_rows($result) > 0) {
   ...
   <th>Monthly salary</th><th>Status</th><th>Update</th><th>Delete</th></tr>";
    ...
    while($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td><a href='update.php?id=" . $row["id"] . " '><button type='button'>Edit</button></a></td>";

        echo '<td><a onclick="return confirm(`Are you sure you want to delete?`)"href="delete.php?id=' . $row["id"] .' "><button type="button">Delete</button></a></td>';
        echo "</tr>";
    }
    echo "</table>";
} else {
