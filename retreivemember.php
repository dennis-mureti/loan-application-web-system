...
<body>
   ...
   <div id="branding">
           ...
           <nav>
               ...
               <li class="current"><a href="retreivemember.php">View member</a></li>
...
<h1 style="font-family: cursive;text-align: center;">View Registered Member</h1>
<?php
...
if (mysqli_num_rows($result) > 0) {
    ...
    echo "<tr><th>ID</th><th>First Name</th><th>Last Name</th><th>Gender</th><th>Address</th><th>Contact</th><th>Email</th><th>Password</th><th>Delete</th></tr>";
    ...
    while($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<td><a onclick="return confirm(`Are you sure you want to delete member?`)"href="Deletemember.php?id=' . $row["id"] .' "><button type="button">Delete</button></a></td>';
        echo "</tr>";
    }
    echo "</table>";
} else {
