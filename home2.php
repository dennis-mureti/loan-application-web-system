...
<body>
   ...
   <div id="branding">
           ...
           <nav>
           	<ul>
           	   <li class="current"><a href="home2.php">Home</a></li>
...
<section id="showcase">
<div class="container">
	<h1>Easy loan application</h1>
	<p>Want to apply for a loan from your SACCO fast and in an easy way?</p>
</div>
</section>
...
<div class="container">
	...
	<img src="images/co1.png">
		<h3>contact us</h3>
		<p>There is no need of spending endless hours in trafic to go apply for a loan</p>
	</div>
</div>
</section>
