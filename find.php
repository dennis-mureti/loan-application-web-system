...
<body>
   ...
   <div id="branding">
           ...
           <nav>
            <ul>
               ...
               <li><a href="loanapplication.php">APPLY lOAN</a></li>
               <li class="current"><a href="find.php">View my application</a></li>
 ...
 <form style="text-align: center; font-weight: bold;border-style: double;" action="find.php" method="post">
 <h1 style="font-family: cursive;text-align: center;">Loan Application</h1>

<h2 style="text-align: center; font-family: italic;">Kindly input your loan id below to view your loan application.</h2>
